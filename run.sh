...
# python3 topo_opt.py --domain beam --objf frequency --confs volume_ub displacement --nx 100 --maxit 100  --vol-frac-ub 0.5 --dis-ub 0.3 --r0 1.0 --grad-check

python3 topo_opt.py --domain beam --objf frequency --confs displacement --nx 100 --maxit 100 --dis-ub 0.3 --r0 1.0 --grad-check
